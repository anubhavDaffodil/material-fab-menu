...
var _children = require('material-ui/lib/utils/children');
...
var _propTypes = require('material-ui/lib/utils/prop-types');
...
var FabMenuButton = _react2.default.createClass({
  displayName: 'FabMenuButton',
  ...
  componentDidMount: function componentDidMount() {
    (0, _warning2.default)(!this.props.iconClassName || !this.props.children, 'You have set both an iconClassName and a child icon. ' + 'It is recommended you use only one method when adding ' + 'icons to FloatingActionButtons.');
  },
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      {
        className: className,
        style: Object.assign(styles.root, this.props.mini && styles.rootWhenMini, this.props.style),
